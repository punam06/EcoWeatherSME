...
function AuthPanel({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: error ? "auth-error-shake" : ""
  }, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
    ...
    points: "20 6 9 17 4 12"
  })) : mode === "forgot" ? "Send Reset Link" : mode === "register" ? "Create Account" : "Sign In"), /*#__PURE__*/React.createElement("div", {
    style: {
      marginTop: "20px",
...
function BatchVerificationForm({
  ...
  const CHECKLIST_ITEMS = [{
    id: 'feedstock',
    en: 'Feedstock meets organic criteria',
    bn: 'ফিডস্টক জৈব মানদণ্ড পূরণ করে'
  }, {
    id: 'sop',
    en: 'SOP compliance verified',
    bn: 'এসওপি সম্মতি যাচাই করা হয়েছে'
  }, {
    id: 'chemicals',
    en: 'No prohibited chemicals used',
    bn: 'কোনো নিষিদ্ধ রাসায়নিক ব্যবহার করা হয়নি'
  }, {
    id: 'logs',
    en: 'Batch temperature logs available',
    bn: 'ব্যাচ তাপমাত্রা লগ পাওয়া যাচ্ছে'
  }];
  const toggleItem = id => {
  ...
  useEffect(() => {
      ...
      try {
        ...
        if (qaSource === 'manufacturer') {
          ...
          if (checkedCount < 3) {
            ...
            if (window.showToast) {
              window.showToast(lang === 'bn' ? 'সতর্কতা: সব সম্মতি আইটেম চেক করা হয়নি।' : 'Warning: Not all compliance items are checked.', 'warning');
            }
          }
        }
    ...
    fetchTrustScore();
  }, [category, pH, EC, temp, ratio, days, onResult, qaSource, checkedItems]);
  return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("div", {
    ...
    value: "manufacturer"
  }, "\uD83C\uDFED Manufacturer Declaration")))), qaSource === 'manufacturer' && /*#__PURE__*/React.createElement("div", {
    style: {
      gridColumn: "1 / -1",
  ...
  }, window.languageManager ? window.languageManager.getLanguage() : 'en' === 'bn' ? 'সম্মতি যাচাইতালিকা' : 'Compliance Checklist'), CHECKLIST_ITEMS.map(item => /*#__PURE__*/React.createElement("label", {
    key: item.id,
    style: {
      display: 'flex',
      alignItems: 'center',
  ...
  }, window.languageManager ? window.languageManager.getLanguage() : 'en' === 'bn' ? item.bn : item.en)))), qaSource === 'iot' && /*#__PURE__*/React.createElement("div", {
    className: "iot-sliders-group",
    style: {
      display: 'contents'
    }
  }, conf.ph ? /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(SliderRow, {
    label: conf.ph.label,
    min: conf.ph.min,
    max: conf.ph.max,
    step: conf.ph.step,
...
function ChatbotView({
  ...
  useEffect(() => {
    const initChatSession = async () => {
      try {
        ...
        const data = await window.apiCall('/api/ai/chat/start', 'POST', {
  ...
  const handleSend = async (text, attachedFileName = null) => {
    ...
    if (orderContext && isYes) {
      try {
        ...
        const voiceData = await window.apiCall('/api/checkout/voice', 'POST', {
          transcript: text
        });
  ...
  return /*#__PURE__*/React.createElement("div", {
  ...
  }, "Listening (", speechLang, ")...")), isVoiceProcessing && /*#__PURE__*/React.createElement("div", {
    className: "voice-order-spinner",
    style: {
      display: "flex",
      alignItems: "center",
      gap: 12,
    ...
    d: "M21 12a9 9 0 11-6.219-8.56"
  })), "Processing voice order..."), !speechSupported && /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "12px 18px",
      fontSize: 12,
      color: ACCENT.amber,
...
function MarketplaceView({
  ...
  }, "No products match your filters.")) : filteredProducts.map(p => {
  ...
  }, isCheckingOut ? "Processing..." : "Place Verified Ledger Order")))), isCheckingOut && /*#__PURE__*/React.createElement(CheckoutDialog, {
    onClose: () => setIsCheckingOut(false),
    onComplete: handleCheckoutComplete,
    totalItems: cart.reduce((sum, item) => sum + item.quantity, 0),
    totalPrice: cartTotal + getShippingCost(),
    zone: selectedZone.replace(/_/g, " ").toUpperCase()
  }), checkoutSuccess && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "fixed",
      top: 0,
      left: 0,
...
function AgentPanel({
  ...
  const initSession = async () => {
    try {
      const userStr = localStorage.getItem("user") || localStorage.getItem("farmer");
      const user = userStr ? JSON.parse(userStr) : null;
      const resData = await window.apiCall('/api/ai/chat/start', 'POST', {
        farmerId: user ? user.id : undefined
      });
  ...
  const endSession = async () => {
    if (!sessionId) return;
    try {
      await window.apiCall('/api/ai/chat/end', 'DELETE', {
        sessionId
      });
      setSessionId("");
    } catch (err) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    }, /*#__PURE__*/React.createElement("div", null, "\uD83C\uDF89 ", msg.content), msg.orderId && isValidOrderUuid(msg.orderId) && /*#__PURE__*/React.createElement(OrderTimeline, {
      status: msg.orderStatus || "pending",
      language: language
    }), msg.orderId && isValidOrderUuid(msg.orderId) && (msg.orderStatus === "pending" || !msg.orderStatus) && /*#__PURE__*/React.createElement("button", {
      type: "button",
...
function DeliveryView({
  ...
  const handleOptimize = async shipmentId => {
    ...
    try {
      await window.apiCall(`/api/deliveries/${shipmentId}/optimize`, {
        method: "PUT"
      });
    } catch (err) {
  ...
  const handleAcknowledge = async shipmentId => {
    ...
    try {
      const json = await window.apiCall(`/api/deliveries/${shipmentId}/acknowledge`, {
        method: "PUT"
      });
      if (json.success) {
  ...
  }, "Loading deliveries...") : shipments.map(s => /*#__PURE__*/React.createElement("div", {
    key: s.id,
    style: {
      background: "var(--bg-input)",
      border: "1px solid var(--border-primary)",
  ...
  }, /*#__PURE__*/React.createElement(DhakaRouteMicroMap, null))), optLog && /*#__PURE__*/React.createElement("div", {
    style: {
...
function CLimaLogixApp() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        const json = await window.apiCall(`/api/products`);
        if (json.success && json.data) {
  ...
  useEffect(() => {
    const fetchGlobalStats = async () => {
      try {
        ...
        console.error("Failed to fetch global stats for header:", err);
      }
    };
    fetchGlobalStats();
