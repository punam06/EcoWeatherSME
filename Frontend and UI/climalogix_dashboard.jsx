...
const UHI_ZONES = {
  ...
  "Old Dhaka":      { offset: 3.4, hazardClass: "A",  hazardMultiplier: 1.80, baseSurvival: 0.90, color: ACCENT.red, lat: 23.7083, lon: 90.4075 },
  "Motijheel":      { offset: 3.1, hazardClass: "A",  hazardMultiplier: 1.70, baseSurvival: 0.92, color: ACCENT.red, lat: 23.7330, lon: 90.4172 },
  "Tejgaon":        { offset: 3.2, hazardClass: "A",  hazardMultiplier: 1.75, baseSurvival: 0.91, color: ACCENT.red, lat: 23.7612, lon: 90.3994 },
  "Hazaribagh":     { offset: 3.5, hazardClass: "A+", hazardMultiplier: 1.85, baseSurvival: 0.88, color: ACCENT.red, lat: 23.7226, lon: 90.3666 },
  "Kamrangirchar":  { offset: 3.3, hazardClass: "A",  hazardMultiplier: 1.78, baseSurvival: 0.90, color: ACCENT.red, lat: 23.7154, lon: 90.3542 },
  "Chowkbazar":     { offset: 3.4, hazardClass: "A",  hazardMultiplier: 1.80, baseSurvival: 0.90, color: ACCENT.red, lat: 23.7163, lon: 90.3971 },
  "Lalbagh":        { offset: 3.2, hazardClass: "A",  hazardMultiplier: 1.75, baseSurvival: 0.91, color: ACCENT.red, lat: 23.7196, lon: 90.3872 },
  "Jatrabari":      { offset: 3.3, hazardClass: "A",  hazardMultiplier: 1.78, baseSurvival: 0.90, color: ACCENT.red, lat: 23.7104, lon: 90.4349 },
  "Sutrapur":       { offset: 3.1, hazardClass: "A",  hazardMultiplier: 1.70, baseSurvival: 0.92, color: ACCENT.red, lat: 23.7051, lon: 90.4218 },
  "Bangshal":       { offset: 3.3, hazardClass: "A",  hazardMultiplier: 1.78, baseSurvival: 0.90, color: ACCENT.red, lat: 23.7167, lon: 90.4061 },
  "Kotwali":        { offset: 3.4, hazardClass: "A",  hazardMultiplier: 1.80, baseSurvival: 0.90, color: ACCENT.red, lat: 23.7050, lon: 90.4083 },
  "Karwan Bazar":   { offset: 3.3, hazardClass: "A",  hazardMultiplier: 1.78, baseSurvival: 0.90, color: ACCENT.red, lat: 23.7516, lon: 90.3934 },

  // Dense Residential / Mixed (Medium-High UHI)
  "Mirpur":         { offset: 2.1, hazardClass: "B-", hazardMultiplier: 1.40, baseSurvival: 1.02, color: ACCENT.amber, lat: 23.8041, lon: 90.3625 },
  "Mirpur 10":      { offset: 2.2, hazardClass: "B",  hazardMultiplier: 1.45, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.8069, lon: 90.3687 },
  "Mirpur 12":      { offset: 2.0, hazardClass: "B-", hazardMultiplier: 1.35, baseSurvival: 1.05, color: ACCENT.amber, lat: 23.8247, lon: 90.3644 },
  "Mohammadpur":    { offset: 2.3, hazardClass: "B",  hazardMultiplier: 1.48, baseSurvival: 1.02, color: ACCENT.amber, lat: 23.7660, lon: 90.3586 },
  "Badda":          { offset: 2.5, hazardClass: "B+", hazardMultiplier: 1.52, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.7805, lon: 90.4267 },
  "Rampura":        { offset: 2.6, hazardClass: "B+", hazardMultiplier: 1.55, baseSurvival: 0.99, color: ACCENT.amber, lat: 23.7612, lon: 90.4244 },
  "Malibagh":       { offset: 2.8, hazardClass: "B+", hazardMultiplier: 1.60, baseSurvival: 0.95, color: ACCENT.amber, lat: 23.7487, lon: 90.4174 },
  "Khilgaon":       { offset: 2.7, hazardClass: "B+", hazardMultiplier: 1.58, baseSurvival: 0.98, color: ACCENT.amber, lat: 23.7508, lon: 90.4303 },
  "Moghbazar":      { offset: 2.9, hazardClass: "A-", hazardMultiplier: 1.65, baseSurvival: 0.94, color: ACCENT.red, lat: 23.7483, lon: 90.4025 },
  "Azimpur":        { offset: 2.4, hazardClass: "B",  hazardMultiplier: 1.50, baseSurvival: 1.01, color: ACCENT.amber, lat: 23.7297, lon: 90.3846 },
  "Shantinagar":    { offset: 2.8, hazardClass: "B+", hazardMultiplier: 1.60, baseSurvival: 0.95, color: ACCENT.amber, lat: 23.7423, lon: 90.4137 },
  "Kakrail":        { offset: 2.7, hazardClass: "B+", hazardMultiplier: 1.58, baseSurvival: 0.98, color: ACCENT.amber, lat: 23.7397, lon: 90.4093 },
  "Paltan":         { offset: 3.0, hazardClass: "A-", hazardMultiplier: 1.68, baseSurvival: 0.93, color: ACCENT.red, lat: 23.7358, lon: 90.4143 },
  "Mugda":          { offset: 2.6, hazardClass: "B+", hazardMultiplier: 1.55, baseSurvival: 0.99, color: ACCENT.amber, lat: 23.7348, lon: 90.4357 },
  "Sabujbagh":      { offset: 2.5, hazardClass: "B+", hazardMultiplier: 1.52, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.7355, lon: 90.4312 },
  "Demra":          { offset: 2.4, hazardClass: "B",  hazardMultiplier: 1.50, baseSurvival: 1.05, color: ACCENT.amber, lat: 23.7042, lon: 90.4578 },
  "Kadamtali":      { offset: 2.6, hazardClass: "B+", hazardMultiplier: 1.55, baseSurvival: 0.99, color: ACCENT.amber, lat: 23.6934, lon: 90.4431 },
  "Shyampur":       { offset: 2.7, hazardClass: "B+", hazardMultiplier: 1.58, baseSurvival: 0.98, color: ACCENT.amber, lat: 23.6847, lon: 90.4287 },
  "Gendaria":       { offset: 2.8, hazardClass: "B+", hazardMultiplier: 1.60, baseSurvival: 0.95, color: ACCENT.amber, lat: 23.7012, lon: 90.4251 },
  "Mohakhali":      { offset: 2.8, hazardClass: "B+", hazardMultiplier: 1.60, baseSurvival: 0.95, color: ACCENT.amber, lat: 23.7778, lon: 90.4056 },
  "Pallabi":        { offset: 2.0, hazardClass: "B-", hazardMultiplier: 1.35, baseSurvival: 1.05, color: ACCENT.amber, lat: 23.8224, lon: 90.3625 },
  "Rupnagar":       { offset: 2.1, hazardClass: "B-", hazardMultiplier: 1.40, baseSurvival: 1.02, color: ACCENT.amber, lat: 23.8183, lon: 90.3533 },
  "Shah Ali":       { offset: 2.2, hazardClass: "B",  hazardMultiplier: 1.45, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.8056, lon: 90.3475 },
  "Darus Salam":    { offset: 2.3, hazardClass: "B",  hazardMultiplier: 1.48, baseSurvival: 1.02, color: ACCENT.amber, lat: 23.7894, lon: 90.3467 },
  "Adabor":         { offset: 2.2, hazardClass: "B",  hazardMultiplier: 1.45, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.7745, lon: 90.3524 },
  "Kalabagan":      { offset: 2.5, hazardClass: "B+", hazardMultiplier: 1.52, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.7487, lon: 90.3768 },
  "New Market":     { offset: 2.9, hazardClass: "A-", hazardMultiplier: 1.65, baseSurvival: 0.94, color: ACCENT.red, lat: 23.7326, lon: 90.3851 },
  "Shahbagh":       { offset: 2.6, hazardClass: "B+", hazardMultiplier: 1.55, baseSurvival: 0.99, color: ACCENT.amber, lat: 23.7389, lon: 90.3956 },
  "Ramna":          { offset: 2.5, hazardClass: "B+", hazardMultiplier: 1.52, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.7461, lon: 90.4011 },
  "Shahjahanpur":   { offset: 2.7, hazardClass: "B+", hazardMultiplier: 1.58, baseSurvival: 0.98, color: ACCENT.amber, lat: 23.7431, lon: 90.4252 },
  "Bhatara":        { offset: 2.4, hazardClass: "B",  hazardMultiplier: 1.50, baseSurvival: 1.01, color: ACCENT.amber, lat: 23.8033, lon: 90.4412 },
  "Bhashantek":     { offset: 2.2, hazardClass: "B",  hazardMultiplier: 1.45, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.8051, lon: 90.3876 },
  "Kafrul":         { offset: 2.3, hazardClass: "B",  hazardMultiplier: 1.48, baseSurvival: 1.02, color: ACCENT.amber, lat: 23.7951, lon: 90.3822 },
  "Sher-e-Bangla":  { offset: 2.0, hazardClass: "B-", hazardMultiplier: 1.35, baseSurvival: 1.05, color: ACCENT.amber, lat: 23.7725, lon: 90.3745 },

  // Planned Residential / Wealthy (Medium-Low UHI)
  "Dhanmondi":      { offset: 2.2, hazardClass: "B",  hazardMultiplier: 1.45, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.7461, lon: 90.3742 },
  "Gulshan":        { offset: 1.3, hazardClass: "C",  hazardMultiplier: 1.10, baseSurvival: 1.20, color: ACCENT.green, lat: 23.7925, lon: 90.4078 },
  "Banani":         { offset: 1.5, hazardClass: "C",  hazardMultiplier: 1.15, baseSurvival: 1.18, color: ACCENT.green, lat: 23.7940, lon: 90.4043 },
  "Baridhara":      { offset: 1.2, hazardClass: "C",  hazardMultiplier: 1.08, baseSurvival: 1.22, color: ACCENT.green, lat: 23.7995, lon: 90.4208 },
  "Niketan":        { offset: 1.6, hazardClass: "C",  hazardMultiplier: 1.18, baseSurvival: 1.15, color: ACCENT.green, lat: 23.7811, lon: 90.4092 },
  "Uttara":         { offset: 1.8, hazardClass: "B-", hazardMultiplier: 1.30, baseSurvival: 1.10, color: ACCENT.amber, lat: 23.8759, lon: 90.3795 },
  "Bashundhara RA": { offset: 1.4, hazardClass: "C",  hazardMultiplier: 1.12, baseSurvival: 1.19, color: ACCENT.green, lat: 23.8192, lon: 90.4308 },

  // Peripheral / Developing / Green (Low UHI)
  "Purbachal":      { offset: 0.8, hazardClass: "C+", hazardMultiplier: 1.02, baseSurvival: 1.28, color: ACCENT.green, lat: 23.8475, lon: 90.5211 },
  "Cantonment":     { offset: 1.0, hazardClass: "C+", hazardMultiplier: 1.05, baseSurvival: 1.25, color: ACCENT.green, lat: 23.8197, lon: 90.3921 },
  "Turag":          { offset: 1.5, hazardClass: "C",  hazardMultiplier: 1.15, baseSurvival: 1.18, color: ACCENT.green, lat: 23.8789, lon: 90.3475 },
  "Khilkhet":       { offset: 1.7, hazardClass: "C",  hazardMultiplier: 1.20, baseSurvival: 1.14, color: ACCENT.green, lat: 23.8286, lon: 90.4194 },
  "Bimanbandar":    { offset: 1.6, hazardClass: "C",  hazardMultiplier: 1.18, baseSurvival: 1.15, color: ACCENT.green, lat: 23.8478, lon: 90.4019 },
  "Uttar Khan":     { offset: 1.4, hazardClass: "C",  hazardMultiplier: 1.12, baseSurvival: 1.19, color: ACCENT.green, lat: 23.8722, lon: 90.4245 },
  "Dakshinkhan":    { offset: 1.5, hazardClass: "C",  hazardMultiplier: 1.15, baseSurvival: 1.18, color: ACCENT.green, lat: 23.8583, lon: 90.4287 },
  "Savar":          { offset: 2.8, hazardClass: "B+", hazardMultiplier: 1.55, baseSurvival: 1.00, color: ACCENT.amber, lat: 23.8488, lon: 90.2687 },
  "Gazipur":        { offset: 2.4, hazardClass: "B",  hazardMultiplier: 1.50, baseSurvival: 1.05, color: ACCENT.amber, lat: 23.9999, lon: 90.4203 },
};
...
function CopyBtn({ text, label }) {
  ...
  return React.createElement('button', {
    ...
    style: {
      ...
      padding: '2px 8px', borderRadius: 6, border: '1px solid var(--border-primary)',
      background: copied ? 'rgba(16,185,129,0.15)' : 'var(--bg-input)',
      color: copied ? '#10B981' : 'var(--text-muted)',
      fontSize: 10, fontWeight: 600, cursor: 'pointer',
      transition: 'all 0.2s ease', verticalAlign: 'middle', lineHeight: '20px',
    }
...
function MicroclimateSimulator({ trustScore, dvs: parentDvs, setDvs: setParentDvs, activeZone, setActiveZone, liveWeather, onDetectGps }) {
            ...
            {isFetchingMetrics ? (
              ...
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", height: 250, gap: 12 }}>
                ...
                <div style={{ fontSize: 13, color: "var(--text-secondary)", textAlign: "center" }}>
                  Adjusted Temp: <strong style={{ color: "var(--text-primary)" }}>{adjustedTemp.toFixed(1)}°C</strong>
                </div>
                <div style={{ fontSize: 11, color: "var(--text-dim)", textAlign: "center", maxWidth: 220 }}>
                  Adjust parameters above, then press <strong>Calculate Viability Score</strong> for DVS, TST &amp; Trust Score.
                </div>
              </div>
            ) : (
              <>
...
function ClimateAdvisoryCard({ recommendations, banglaText, onSpeak, isSpeaking }) {
  ...
  return (
    <Card style={{ marginTop: 20, border: `1px solid ${meterColor}33`, boxShadow: `0 0 24px ${meterColor}18` }}>
      <SectionLabel icon="🌡️" text="Climate Advisory Card" />
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: 20 }}>
        <div>
          <div style={{ fontSize: 11, color: "var(--text-dim)", letterSpacing: "0.08em", fontWeight: 600, marginBottom: 10 }}>
            ACTIVE COMPOUND LIFESPAN
          </div>
          <div style={{ position: "relative", height: 18, borderRadius: 999, overflow: "hidden", background: "var(--gauge-track)", marginBottom: 8 }}>
            <div style={{
            ...
            <div style={{
              ...
              width: 3, background: "#fff", boxShadow: "0 0 8px rgba(255,255,255,0.8)",
          ...
          <div style={{ display: "flex", justifyContent: "space-between", fontSize: 10, color: "var(--text-dim)", marginBottom: 14 }}>
            ...
            <span style={{ color: ACCENT.amber }}>Caution</span>
            <span style={{ color: ACCENT.green }}>Stable</span>
          </div>
          <div style={{ display: "flex", alignItems: "baseline", gap: 8, marginBottom: 6 }}>
            <span style={{ fontSize: 36, fontWeight: 800, color: meterColor, fontFamily: "'JetBrains Mono', monospace" }}>{pct}%</span>
            <span style={{ fontSize: 12, color: "var(--text-secondary)" }}>estimated viability</span>
          </div>
          <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
            <span style={{
              fontSize: 10, fontWeight: 700, padding: "4px 10px", borderRadius: 6,
              background: meterColor + "18", color: meterColor, border: `1px solid ${meterColor}44`,
              letterSpacing: "0.06em",
            }}>{recommendations.risk_level} RISK</span>
            <span style={{
              fontSize: 10, padding: "4px 10px", borderRadius: 6,
              background: "var(--bg-input)", color: "var(--text-secondary)",
              border: "1px solid var(--border-primary)", fontFamily: "'JetBrains Mono', monospace",
            }}>{recommendations.days_viable} days viable</span>
          </div>
        </div>

        <div>
          <div style={{ fontSize: 12, color: "var(--text-secondary)", marginBottom: 8, lineHeight: 1.5 }}>
            {recommendations.best_sale_window}
          </div>
          <label style={{
            display: "block", fontSize: 11, fontWeight: 700, color: ACCENT.green,
            letterSpacing: "0.06em", marginBottom: 8,
          }}>
            আপনার জন্য পরামর্শ (AI Recommendation)
          </label>
          <div style={{
            padding: "14px 16px", borderRadius: 10, minHeight: 88,
          ...
          >
            <span style={{ fontSize: 18 }}>{isSpeaking ? "🔊" : "🔈"}</span>
            {isSpeaking ? "পড়া হচ্ছে…" : "শুনুন (Text-to-Speech)"}
          </button>
        </div>
      </div>
    </Card>
...
function SMEInventoryTracker({ activeZone = "Mirpur" }) {
  ...
  const banglaText = claimResult?.recommendations
    ? translateSaleWindowToBangla(
        claimResult.recommendations.best_sale_window,
        claimResult.recommendations.days_viable,
        claimResult.recommendations.risk_level,
      )
    : "";
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1.1fr 0.9fr", gap: 20 }}>
        <Card hover={false}>
          ...
          <div style={{ marginTop: 16 }}>
            <label style={{ fontSize: 11, color: "var(--text-secondary)", fontWeight: 600, letterSpacing: "0.06em", display: "block", marginBottom: 8 }}>
              BATCH UUID (SIMULATED SCAN PAYLOAD)
            </label>
            <input
              type="text"
              value={batchUuid}
          ...
          {error && (
            <div style={{
              ...
              background: ACCENT.redBg, border: `1px solid ${ACCENT.redBorder}`,
              color: ACCENT.red, fontSize: 12,
            }}>{error}</div>
          )}
        </Card>

        <Card hover={false}>
          <SectionLabel icon="📍" text="Intake Context" />
          <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            {[
              { label: "SME Zone (MERM)", value: activeZone, icon: "🗺️" },
              { label: "Storage Default", value: "Shaded warehouse", icon: "🏪" },
              { label: "API Endpoint", value: "POST /api/qr/sme-claim/:id", icon: "🔗" },
            ].map((row) => (
              <div key={row.label} style={{
                ...
                <div>
                  <div style={{ fontSize: 10, color: "var(--text-dim)", letterSpacing: "0.08em", fontWeight: 600 }}>{row.label.toUpperCase()}</div>
                  <div style={{ fontSize: 13, color: "var(--text-primary)", fontWeight: 500, marginTop: 2 }}>{row.value}</div>
                </div>
              </div>
            ))}
          </div>
          <div style={{
            ...
            background: "rgba(16,185,129,0.06)", border: `1px solid ${ACCENT.greenBorder}`,
            fontSize: 12, color: "var(--text-secondary)", lineHeight: 1.55,
          }}>
            Scanning triggers inventory save (<code style={{ color: ACCENT.green }}>sme_inventory</code>), logs GPS/IP to the custody ledger, and runs the predictive sale-window engine using live weather + UHI offsets.
          </div>
        </Card>
      </div>

      {claimResult?.product_saved && (
        <ClimateAdvisoryCard
...
function ChatbotView({ setTab, products = [], setVerificationBatchId, setVerificationDispatchZone, setMarketplaceSubTab }) {
      ...
      if (data.success && data.data) {
        ...
        if (agentResponse.type === "NAVIGATION" && agentResponse.navigationTarget) {
          ...
          if (agentResponse.navigationTarget.toLowerCase() === 'confirmed_orders') {
            ...
            setTimeout(() => { setTab('marketplace'); }, 1500);
            return;
          }
          const pageRoutes = {
            'dashboard': 0,
          ...
          if (targetIndex !== undefined) {
            ...
            setTimeout(() => { setTab(agentResponse.navigationTarget); }, 1500);
          }
        }
...
function MarketplaceView({ products = [], isLoading = false, marketplaceSubTab = "inventory", setMarketplaceSubTab }) {
  const [search, setSearch] = useState("");
  ...
  useEffect(() => {
    ...
    const DEMO_CATALOG = [
      { id: "demo-1", name: "Premium Organic Compost", category: "Agriculture", price: "৳ 240", unit: "Kg", dvs: 92, trust_score: 91, icon: "🌱", seller: "Green Refineries Ltd.", badge: "BARI Certified", status: "active" },
      { id: "demo-2", name: "Carbon-Neutral Biochar", category: "Agriculture", price: "৳ 150", unit: "Kg", dvs: 88, trust_score: 88, icon: "🪨", seller: "EcoFarm BD", badge: "Eco-Verified", status: "active" },
      { id: "demo-3", name: "Trichoderma Bio-Fungicide", category: "Agriculture", price: "৳ 320", unit: "Litre", dvs: 85, trust_score: 86, icon: "🧪", seller: "AgriShield Corp", badge: null, status: "active" },
      { id: "demo-4", name: "Neem-Based Pesticide", category: "Agriculture", price: "৳ 180", unit: "Litre", dvs: 79, trust_score: 83, icon: "🌿", seller: "NaturePest BD", badge: null, status: "active" },
      { id: "demo-5", name: "Rhizobium Biofertilizer", category: "Agriculture", price: "৳ 95", unit: "Pack", dvs: 90, trust_score: 89, icon: "🦠", seller: "BioGrow Ltd.", badge: "BARI Certified", status: "active" },
      { id: "demo-6", name: "Vermicompost (Earthworm)", category: "Agriculture", price: "৳ 60", unit: "Kg", dvs: 95, trust_score: 94, icon: "🪱", seller: "Green Refineries Ltd.", badge: "Premium", status: "active" },
      { id: "demo-7", name: "Liquid Seaweed Extract", category: "Agriculture", price: "৳ 275", unit: "Litre", dvs: 71, trust_score: 80, icon: "🌊", seller: "OceanAgro SME", badge: "⚡ CLEARANCE", status: "active" },
      { id: "demo-8", name: "Organic Phosphate Mix", category: "Agriculture", price: "৳ 130", unit: "Kg", dvs: 87, trust_score: 85, icon: "⚗️", seller: "AgriShield Corp", badge: null, status: "active" },
    ];
    ...
    const fetchInventory = async () => {
      try {
        ...
        if (window.supabaseClient) {
          const { data: batchData, error: batchError } = await window.supabaseClient
            .from('batches')
            .select('id, batch_number, product_name, status, created_at, trust_score, destination_zone, processor_id')
            .in('status', ['active', 'certified', 'sme_inventory', 'pending'])
      ...
      try {
        if (window.supabaseClient) {
          ...
          const [res1, res2] = await Promise.allSettled([
            window.supabaseClient.from('orders').select('*').eq('status', 'completed').order('created_at', { ascending: false }).limit(30),
            window.supabaseClient.from('checkout_orders').select('*').eq('status', 'confirmed').order('created_at', { ascending: false }).limit(30)
          ]);
        ...
        <Card hover={false} style={{ padding: "32px", borderRadius: 16 }}>
          ...
          <div style={{ padding: "20px 0 0 0", borderTop: "1px solid var(--border-primary)", marginTop: 24, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div style={{ fontSize: 12, color: "var(--text-secondary)", lineHeight: 1.5 }}>
              📋 Product info is sourced from the verified BARI trust ledger.
            </div>
            <button 
              onClick={() => setSelectedProduct(null)}
  ...
  return (
    <div style={{ animation: "fadeSlideIn 0.3s ease", position: "relative" }}>
      <div style={{ marginBottom: 16 }}>
        <PageHeader title="SME Reverse Marketplace" subtitle="Active inventory and confirmed orders from verified BARI-certified suppliers" />
      </div>

      {/* ── SUB-TAB SWITCHER ─────────────────────────────────────── */}
      <div style={{ display: "flex", gap: 8, marginBottom: 24, background: "var(--bg-input)", padding: "6px", borderRadius: 10, border: "1px solid var(--border-primary)", width: "fit-content" }}>
        {[
          { id: "inventory", label: "📦 Active Inventory", desc: "Available Products" },
          { id: "confirmed", label: "✅ Confirmed Orders", desc: "Completed Orders" },
        ].map(tab => (
          <button
            key={tab.id}
            ...
            return (
              ...
              >
                ...
                <div style={{ marginTop: "auto" }}>
                  ...
                  <button 
                    onClick={() => { setSelectedProduct(p); setQuantityInput(1); }}
                    style={{ width: "100%", padding: "10px 0", background: "var(--bg-input)", border: `1px solid ${ACCENT.greenBorder}`, borderRadius: 8, color: ACCENT.green, fontWeight: 600, cursor: "pointer", fontSize: 13, transition: "background 0.2s" }}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: 20, marginBottom: 80 }}>
            {isLoadingInventory ? (
              ...
              <div style={{ gridColumn: "1 / -1", padding: 60, textAlign: "center", color: "var(--text-secondary)" }}>
                ...
                <div style={{ fontSize: 16, fontWeight: 500, marginBottom: 8 }}>No active inventory items found.</div>
                <div style={{ fontSize: 13, color: "var(--text-dim)" }}>Products verified on the BARI trust ledger will appear here once available.</div>
              </div>
            ) : (
              filteredProducts.map(p => {
                const rawPrice = Number((p.price || "").replace(/[৳\s,]/g, ""));
                ...
                return (
                  ...
                  >
                    {isClearance ? (
                      <div style={{ position: "absolute", top: 16, right: 16, background: ACCENT.redBg, color: ACCENT.red, padding: "4px 10px", borderRadius: 4, fontSize: 10, fontWeight: 700, letterSpacing: "0.05em", border: `1px solid ${ACCENT.redBorder}`, animation: "pulseGlow 2s infinite" }}>
                        ⚡ DYNAMIC CLEARANCE
                      </div>
                    ) : p.badge ? (
                      <div style={{ position: "absolute", top: 16, right: 16, background: p.badge.includes("Critical") ? ACCENT.redBg : ACCENT.blueBg, color: p.badge.includes("Critical") ? ACCENT.red : ACCENT.blue, padding: "4px 10px", borderRadius: 4, fontSize: 10, fontWeight: 700, letterSpacing: "0.05em", border: `1px solid ${p.badge.includes("Critical") ? ACCENT.redBorder : "var(--border-primary)"}` }}>
                    ...
                    <div style={{ marginTop: "auto" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 16, paddingBottom: 16, borderBottom: "1px solid var(--border-primary)" }}>
                        ...
                        <div style={{ textAlign: "right" }}>
                          <div style={{ fontSize: 18, fontWeight: 700, color: (p.dvs || 0) >= 90 ? ACCENT.green : (p.dvs || 0) >= 75 ? ACCENT.blue : ACCENT.amber, fontFamily: "'JetBrains Mono', monospace", lineHeight: 1 }}>{p.dvs || '—'}</div>
                          <div style={{ fontSize: 10, color: "var(--text-dim)", marginTop: 4, fontWeight: 600 }}>DVS SCORE</div>
                        </div>
                      </div>
      ...
      {/* ── SUB-VIEW: CONFIRMED ORDERS ────────────────────────── */}
      {marketplaceSubTab === "confirmed" && (
        <div style={{ animation: "fadeSlideIn 0.3s ease" }}>
          {isLoadingOrders ? (
            <Card hover={false} style={{ padding: 32 }}>
              <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} style={{ display: "grid", gridTemplateColumns: "1fr 2fr 1fr 1fr 1fr", gap: 16, alignItems: "center" }}>
                    {Array.from({ length: 5 }).map((__, j) => (
                      <div key={j} style={{ height: 14, borderRadius: 4, background: "var(--border-primary)", animation: "pulse 1.5s infinite" }} />
                    ))}
                  </div>
                ))}
              </div>
            ...
            <Card hover={false} style={{ padding: 40, textAlign: "center" }}>
              ...
              <div style={{ fontSize: 14, color: ACCENT.red, marginBottom: 8 }}>{ordersError}</div>
              <button onClick={() => setMarketplaceSubTab && setMarketplaceSubTab("confirmed")} style={{ padding: "8px 20px", borderRadius: 8, border: `1px solid ${ACCENT.greenBorder}`, background: "transparent", color: ACCENT.green, cursor: "pointer", fontSize: 13 }}>Retry</button>
            </Card>
          ) : confirmedOrders.length === 0 ? (
            <Card hover={false} style={{ padding: 60, textAlign: "center" }}>
              <div style={{ fontSize: 48, marginBottom: 16 }}>✅</div>
              <div style={{ fontSize: 16, fontWeight: 500, marginBottom: 8 }}>No confirmed orders yet.</div>
              <div style={{ fontSize: 13, color: "var(--text-dim)" }}>Completed and confirmed orders from the ledger will appear here.</div>
            </Card>
          ) : (
            <Card hover={false} style={{ padding: 0, overflow: "hidden" }}>
              <div style={{ padding: "16px 24px", borderBottom: "1px solid var(--border-primary)", display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <span style={{ fontWeight: 700, fontSize: 15 }}>Confirmed Orders</span>
                <span style={{ marginLeft: "auto", fontSize: 12, color: "var(--text-dim)", padding: "3px 10px", borderRadius: 20, background: "var(--bg-input)", border: "1px solid var(--border-primary)" }}>{confirmedOrders.length} records</span>
              </div>
              <div style={{ overflowX: "auto" }}>
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                  <thead>
                    <tr style={{ background: "var(--bg-input)", textAlign: "left" }}>
                      {["Order ID", "Product", "Qty", "Status", "Date"].map(h => (
                        <th key={h} style={{ padding: "12px 20px", fontWeight: 600, fontSize: 11, color: "var(--text-secondary)", letterSpacing: "0.05em", textTransform: "uppercase", borderBottom: "1px solid var(--border-primary)" }}>{h}</th>
                      ))}
                    </tr>
                  </thead>
                  <tbody>
                    {confirmedOrders.map((order, idx) => (
                      <tr key={order.id} style={{ borderBottom: "1px solid var(--border-primary)", transition: "background 0.15s" }}
                        ...
                        onMouseLeave={e => e.currentTarget.style.background = "transparent"}
                      >
                        <td style={{ padding: "12px 20px", fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: ACCENT.blue }}>
                        ...
                        <td style={{ padding: "12px 20px" }}>
                          <span style={{
                            ...
                            border: `1px solid ${ACCENT.greenBorder}`, letterSpacing: "0.05em"
                          }}>
                            {String(order.status || 'confirmed').toUpperCase()}
                          </span>
                        </td>
                        <td style={{ padding: "12px 20px", fontSize: 11, color: "var(--text-dim)", fontFamily: "'JetBrains Mono', monospace" }}>
...
function AgentPanel({ setTab, products = [], setVerificationBatchId, setVerificationDispatchZone, setMarketplaceSubTab }) {
  const [isOpen, setIsOpen] = useState(false);
  const [messages, setMessages] = useState([
    {
      role: "assistant",
...
function HeroLandingPage({ onLogin, onRegister }) {
  ...
  return (
    <div style={{ background: "#0B0F19", color: "#F9FAFB", fontFamily: "'Inter', sans-serif", minHeight: "100vh", overflowX: "hidden" }}>
      <style>{`
        .scroll-animate {
          opacity: 0;
      ...
      <nav style={{
        ...
        WebkitBackdropFilter: "blur(12px)", borderBottom: "1px solid rgba(16, 185, 129, 0.15)",
        height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between",
        padding: "0 24px"
      }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px", cursor: "pointer" }}>
          <span style={{ fontSize: "22px" }}>🌍</span>
          <span style={{ fontFamily: "Inter", fontWeight: "800", fontSize: "19px", letterSpacing: "-0.02em", color: "#F9FAFB" }}>
            ClimaLogix<span style={{ color: "#10B981" }}>.ai</span>
          </span>
        </div>

        {/* Desktop Nav Links */}
        <div className="hidden-mobile" style={{ display: "flex", alignItems: "center", gap: "28px" }}>
          <a href="#features" style={{ color: "#94A3B8", textDecoration: "none", fontSize: "14px", fontWeight: "500", transition: "color 0.2s" }} onMouseOver={e=>e.target.style.color="#10B981"} onMouseOut={e=>e.target.style.color="#94A3B8"}>Features</a>
          <a href="#demo" style={{ color: "#94A3B8", textDecoration: "none", fontSize: "14px", fontWeight: "500", transition: "color 0.2s" }} onMouseOver={e=>e.target.style.color="#10B981"} onMouseOut={e=>e.target.style.color="#94A3B8"}>Demo</a>
          <a href="#testimonials" style={{ color: "#94A3B8", textDecoration: "none", fontSize: "14px", fontWeight: "500", transition: "color 0.2s" }} onMouseOver={e=>e.target.style.color="#10B981"} onMouseOut={e=>e.target.style.color="#94A3B8"}>Pricing</a>
          <a href="#docs" style={{ color: "#94A3B8", textDecoration: "none", fontSize: "14px", fontWeight: "500", transition: "color 0.2s" }} onMouseOver={e=>e.target.style.color="#10B981"} onMouseOut={e=>e.target.style.color="#94A3B8"}>Docs</a>
          
          <button onClick={onLogin} style={{
            background: "transparent", border: "1px solid #10B981", borderRadius: "8px",
            color: "#10B981", padding: "8px 16px", cursor: "pointer", fontSize: "14px", fontWeight: "600",
            transition: "all 0.2s"
          }} onMouseOver={e=>{e.target.style.background="rgba(16, 185, 129, 0.1)"}} onMouseOut={e=>e.target.style.background="transparent"}>
            Login
          </button>
          
          <button onClick={onRegister} className="cta-primary" style={{
            border: "none", borderRadius: "8px", color: "#0B0F19", padding: "8px 18px",
        ...
        <button 
          ...
          style={{ background: "transparent", border: "none", color: "#F9FAFB", cursor: "pointer", fontSize: "24px" }}
        >
          {mobileMenuOpen ? "✕" : "☰"}
        </button>
        ...
        <div className={`mobile-drawer ${mobileMenuOpen ? 'open' : ''}`} style={{
          ...
          background: "#0B0F19", borderLeft: "1px solid rgba(16, 185, 129, 0.15)",
          display: "flex", flexDirection: "column", padding: "24px", gap: "20px", zIndex: 49,
          boxShadow: "-10px 0 30px rgba(0,0,0,0.5)"
        }}>
          <a href="#features" onClick={()=>setMobileMenuOpen(false)} style={{ color: "#F9FAFB", textDecoration: "none", fontSize: "16px", fontWeight: "600" }}>Features</a>
          <a href="#demo" onClick={()=>setMobileMenuOpen(false)} style={{ color: "#F9FAFB", textDecoration: "none", fontSize: "16px", fontWeight: "600" }}>Demo</a>
          <a href="#testimonials" onClick={()=>setMobileMenuOpen(false)} style={{ color: "#F9FAFB", textDecoration: "none", fontSize: "16px", fontWeight: "600" }}>Pricing</a>
          <a href="#docs" onClick={()=>setMobileMenuOpen(false)} style={{ color: "#F9FAFB", textDecoration: "none", fontSize: "16px", fontWeight: "600" }}>Docs</a>
          <hr style={{ border: "none", borderTop: "1px solid rgba(255,255,255,0.08)" }} />
          <button onClick={() => { setMobileMenuOpen(false); onLogin(); }} style={{
            background: "transparent", border: "1px solid #10B981", borderRadius: "8px",
            color: "#10B981", padding: "12px", cursor: "pointer", fontSize: "15px", fontWeight: "600"
          }}>
            Login
          </button>
          <button onClick={() => { setMobileMenuOpen(false); onRegister(); }} className="cta-primary" style={{
            border: "none", borderRadius: "8px", color: "#0B0F19", padding: "12px",
      ...
      <section style={{
        minHeight: "100vh", display: "grid", gridTemplateColumns: "1.2fr 1fr",
        padding: "100px 40px 40px", gap: "40px", alignItems: "center",
        maxWidth: "1400px", margin: "0 auto", boxSizing: "border-box"
      }} className="stack-mobile">
        {/* Left Column */}
        <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
          <div className="scroll-animate" style={{ alignSelf: "flex-start" }}>
            <span style={{
              background: "rgba(16, 185, 129, 0.08)", border: "1px solid rgba(16, 185, 129, 0.3)",
              borderRadius: "9999px", padding: "6px 14px", fontSize: "11px", fontWeight: "700",
              color: "#10B981", letterSpacing: "0.05em", textTransform: "uppercase"
            }}>
              📡 AI-Powered Climate Logistics
            </span>
          </div>

          <h1 className="hero-title scroll-animate delay-100" style={{ fontSize: "clamp(32px, 5vw, 52px)", fontWeight: "800", lineHeight: "1.1", letterSpacing: "-0.03em" }}>
            Protect Your Supply Chain from the <span>Heat</span>
          </h1>

          <p className="scroll-animate delay-200" style={{ fontSize: "17px", color: "#D1D5DB", lineHeight: "1.6", maxWidth: "600px" }}>
            ClimaLogix AI monitors real-time thermal conditions, optimizes heat-safe routes, and shields SME logistics in climate-vulnerable regions like Bangladesh.
          </p>

          <div className="scroll-animate delay-300" style={{ display: "flex", gap: "16px", flexWrap: "wrap", marginTop: "8px" }}>
            <button onClick={onRegister} className="cta-primary" style={{
              border: "none", borderRadius: "10px", color: "#0B0F19", padding: "14px 28px",
              cursor: "pointer", fontSize: "15px", fontWeight: "700"
            }}>
              Get Started Free
            </button>
            <a href="#demo" className="cta-secondary" style={{
              borderRadius: "10px", padding: "14px 28px", textDecoration: "none",
              textAlign: "center", fontSize: "15px", fontWeight: "700", display: "inline-block"
            }}>
              Watch Demo
            </a>
          </div>

          <div className="scroll-animate delay-400" style={{ display: "flex", gap: "24px", flexWrap: "wrap", borderTop: "1px solid rgba(255,255,255,0.06)", paddingTop: "28px", marginTop: "16px" }}>
            <div>
              <div style={{ fontFamily: "'JetBrains Mono', monospace", color: "#10B981", fontSize: "24px", fontWeight: "700" }}>2,400+</div>
              <div style={{ color: "#CBD5E1", fontSize: "12px", marginTop: "2px" }}>SMEs Protected</div>
            </div>
            <div style={{ width: "1px", background: "rgba(255,255,255,0.1)" }}></div>
            <div>
              <div style={{ fontFamily: "'JetBrains Mono', monospace", color: "#10B981", fontSize: "24px", fontWeight: "700" }}>98.7%</div>
              <div style={{ color: "#CBD5E1", fontSize: "12px", marginTop: "2px" }}>Route Accuracy</div>
            </div>
            <div style={{ width: "1px", background: "rgba(255,255,255,0.1)" }}></div>
            <div>
              <div style={{ fontFamily: "'JetBrains Mono', monospace", color: "#10B981", fontSize: "24px", fontWeight: "700" }}>12+</div>
              <div style={{ color: "#CBD5E1", fontSize: "12px", marginTop: "2px" }}>Districts Active</div>
            </div>
          </div>
        </div>

        {/* Right Column (3D Interactive Canvas) */}
        <div className="scroll-animate delay-300" style={{ height: "100%", minHeight: "450px", position: "relative" }}>
          {window.ThreeScene ? <window.ThreeScene /> : <div style={{ color: "#10B981" }}>Loading 3D Atmosphere Scene...</div>}
        </div>
      </section>

      {/* SECTION 2 — PROBLEM STATEMENT */}
      <section id="features" style={{ background: "#111827", padding: "100px 40px", borderTop: "1px solid rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.04)" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          <div className="scroll-animate" style={{ textAlign: "center", marginBottom: "64px" }}>
            <h2 style={{ fontSize: "clamp(26px, 4vw, 36px)", fontWeight: "800", maxWidth: "800px", margin: "0 auto 18px", lineHeight: "1.2" }}>
              Bangladesh Loses Billions to Heat-Damaged Goods Every Year
            </h2>
            <p style={{ color: "#94A3B8", fontSize: "16px", maxWidth: "600px", margin: "0 auto" }}>
              Traditional shipping models fail to protect delicate assets during seasonal heat spikes in urban logistics paths.
            </p>
          </div>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "28px" }} className="stack-mobile">
            {/* Card 1 */}
            <div className="glass-panel problem-card scroll-animate" style={{ padding: "32px" }}>
              <div style={{ fontSize: "32px", marginBottom: "16px" }}>🌡️</div>
              <h3 style={{ fontSize: "18px", fontWeight: "700", marginBottom: "12px" }}>Extreme Heat Events</h3>
              <p style={{ color: "#94A3B8", fontSize: "14px", lineHeight: "1.6" }}>
                Temperature spikes above 42°C devastate perishable agricultural and biological goods without real-time microclimate monitoring.
              </p>
            </div>

            {/* Card 2 */}
            <div className="glass-panel problem-card scroll-animate delay-150" style={{ padding: "32px" }}>
              <div style={{ fontSize: "32px", marginBottom: "16px" }}>🚛</div>
              <h3 style={{ fontSize: "18px", fontWeight: "700", marginBottom: "12px" }}>Blind Route Planning</h3>
              <p style={{ color: "#94A3B8", fontSize: "14px", lineHeight: "1.6" }}>
                Drivers navigate without corridor-specific thermal risk data, exposing high-value shipments to critical temperature zones.
              </p>
            </div>

            {/* Card 3 */}
            <div className="glass-panel problem-card scroll-animate delay-300" style={{ padding: "32px" }}>
              <div style={{ fontSize: "32px", marginBottom: "16px" }}>📦</div>
              <h3 style={{ fontSize: "18px", fontWeight: "700", marginBottom: "12px" }}>No Cold-Chain Visibility</h3>
              <p style={{ color: "#94A3B8", fontSize: "14px", lineHeight: "1.6" }}>
                SMEs lack affordable IoT analytics to track batch quality degradation, insulation metrics, and precise spoilage risk.
              </p>
            </div>
          </div>
        </div>
      ...
      <section style={{ padding: "100px 40px", maxWidth: "1200px", margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.2fr", gap: "60px" }} className="stack-mobile">
          {/* Left Column (Sticky Title) */}
          <div style={{ position: "sticky", top: "100px", height: "fit-content" }}>
            <div className="scroll-animate">
              <span style={{ color: "#10B981", fontSize: "11px", fontWeight: "700", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                Proven Protection
              </span>
              <h2 style={{ fontSize: "clamp(26px, 4vw, 36px)", fontWeight: "800", margin: "12px 0 18px", lineHeight: "1.2" }}>
                How ClimaLogix Protects You
              </h2>
              <p style={{ color: "#94A3B8", fontSize: "15px", lineHeight: "1.6" }}>
                ClimaLogix AI equips local merchants and transport networks with the exact computational tools needed to bypass urban heat islands and log certified batch health.
              </p>
            </div>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "36px" }}>
            {[
              { num: "01", icon: "🛰️", title: "Real-Time Heat Monitoring", desc: "OpenWeather + local IoT integration delivers live microclimate telemetry across your entire transit route." },
              { num: "02", icon: "🧭", title: "AI Route Optimization", desc: "Dynamic heat-risk scores predict UHI hotspots and automatically redirect drivers before thermal damage occurs." },
              { num: "03", icon: "📊", title: "TST Analytics Engine", desc: "Our proprietary Thermal Survival Time algorithm models packaging ratings to forecast shipment stability windows." },
              { num: "04", icon: "🔔", title: "Instant Smart Alerts", desc: "Push notifications trigger when temperature parameters cross set safety thresholds. Never risk a cargo blindly." },
              { num: "05", icon: "🗣", title: "Multilingual Voice Assistant", desc: "Fully integrated voice portal translates spoken Bangla and English commands for local drivers in transit." }
            ].map((f, i) => (
              <div key={i} className="glass-panel scroll-animate" style={{ padding: "24px", display: "flex", gap: "20px", alignItems: "flex-start" }}>
                <div className="feature-num" style={{ fontSize: "22px", fontWeight: "700" }}>{f.num}</div>
      ...
      <section id="demo" style={{ background: "#111827", padding: "100px 40px", borderTop: "1px solid rgba(255,255,255,0.04)" }}>
        <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
          <div className="scroll-animate" style={{ textAlign: "center", marginBottom: "50px" }}>
            <h2 style={{ fontSize: "clamp(26px, 4vw, 36px)", fontWeight: "800", marginBottom: "14px" }}>See It in Action</h2>
            <p style={{ color: "#94A3B8", fontSize: "15px" }}>Drag the slider to adjust outside temperature and watch ClimaLogix model route hazards in real-time.</p>
          </div>

          <div className="glass-panel scroll-animate stack-mobile" style={{ padding: "36px", display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "40px" }}>
            {/* Controls */}
            <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
              <div>
                <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "10px" }}>
                  <span style={{ fontSize: "14px", fontWeight: "600", color: "#94A3B8" }}>Outside Ambient Temperature:</span>
                  <span style={{ fontFamily: "monospace", fontSize: "18px", fontWeight: "700", color: riskColor }}>{temp}°C</span>
                </div>
                <input 
              ...
              <div style={{ background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "12px", padding: "20px" }}>
                <div style={{ fontSize: "12px", color: "#64748B", textTransform: "uppercase", fontWeight: "600", letterSpacing: "0.05em" }}>Analysis Result</div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "12px" }}>
                  <span style={{ fontSize: "14px", color: "#94A3B8" }}>Hazard Risk Level:</span>
                  <span style={{ color: riskColor, fontWeight: "800", fontSize: "14px", background: `${riskColor}15`, border: `1px solid ${riskColor}30`, borderRadius: "9999px", padding: "4px 14px", letterSpacing: "0.05em" }}>
                    {routeRisk}
                  </span>
                </div>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "16px" }}>
                  <span style={{ fontSize: "14px", color: "#94A3B8" }}>Calculated TST:</span>
                  <span style={{ fontFamily: "'JetBrains Mono', monospace", fontWeight: "700", color: "#F9FAFB", fontSize: "17px" }}>
                    {calculatedTst} minutes
                  </span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: "16px" }}>
              <div style={{ fontSize: "12px", color: "#64748B", textTransform: "uppercase", fontWeight: "600" }}>Bangladesh Route Hazard Map</div>
              <svg width="180" height="240" viewBox="0 0 200 280" style={{ filter: "drop-shadow(0 10px 20px rgba(0,0,0,0.5))" }}>
                {/* Simplified outline of Bangladesh Map */}
                <path d="M 60 20 L 100 10 L 140 30 L 150 70 L 170 120 L 190 180 L 160 220 L 170 270 L 120 270 L 100 240 L 90 260 L 50 240 L 30 200 L 20 150 L 40 100 L 30 70 Z" fill="rgba(16, 185, 129, 0.05)" stroke="rgba(16, 185, 129, 0.2)" strokeWidth="2" />
                
                {/* Zone 1: Dhaka (North) */}
                <circle cx="95" cy="110" r="14" className="map-zone" fill={temp >= 40 ? "#EF444455" : temp >= 33 ? "#F59E0B55" : "#10B98155"} stroke={temp >= 40 ? "#EF4444" : temp >= 33 ? "#F59E0B" : "#10B981"} strokeWidth="2" />
                <text x="95" y="114" fill="#FFF" fontSize="9" fontWeight="700" textAnchor="middle">Zone A</text>

                {/* Zone 2: Chittagong (South-East) */}
                <circle cx="145" cy="200" r="14" className="map-zone" fill={temp >= 44 ? "#EF444455" : temp >= 35 ? "#F59E0B55" : "#10B98155"} stroke={temp >= 44 ? "#EF4444" : temp >= 35 ? "#F59E0B" : "#10B981"} strokeWidth="2" />
                <text x="145" y="204" fill="#FFF" fontSize="9" fontWeight="700" textAnchor="middle">Zone B</text>

                {/* Zone 3: Khulna (South-West) */}
                <circle cx="55" cy="210" r="14" className="map-zone" fill={temp >= 38 ? "#EF444455" : temp >= 30 ? "#F59E0B55" : "#10B98155"} stroke={temp >= 38 ? "#EF4444" : temp >= 30 ? "#F59E0B" : "#10B981"} strokeWidth="2" />
                <text x="55" y="214" fill="#FFF" fontSize="9" fontWeight="700" textAnchor="middle">Zone C</text>
              </svg>
            </div>
          </div>
        </div>
      ...
      <section id="testimonials" style={{ padding: "100px 40px", maxWidth: "1200px", margin: "0 auto" }}>
        <div className="scroll-animate" style={{ textAlign: "center", marginBottom: "64px" }}>
          <span style={{ color: "#10B981", fontSize: "11px", fontWeight: "700", letterSpacing: "0.1em", textTransform: "uppercase" }}>Testimonials</span>
          <h2 style={{ fontSize: "clamp(26px, 4vw, 36px)", fontWeight: "800", marginTop: "12px" }}>Trusted by SMEs Across Bangladesh</h2>
        </div>

        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "28px" }} className="stack-mobile">
          {/* Card 1 */}
          <div className="glass-panel scroll-animate" style={{ padding: "30px", display: "flex", flexDirection: "column", gap: "16px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              ...
              <div>
                <div style={{ fontWeight: "700", fontSize: "14px" }}>Anwar Hossain</div>
                <div style={{ fontSize: "11px", color: "#64748B" }}>Agro-Biologicals Supplier, Savar</div>
              </div>
            </div>
            <div style={{ color: "#10B981", fontSize: "12px" }}>★★★★★</div>
            <p style={{ color: "#CBD5E1", fontSize: "13.5px", lineHeight: "1.6", fontStyle: "italic" }}>
              "Before ClimaLogix, we lost up to 30% of organic fertilizer active bio-cultures during Dhaka midday heat spikes. Now we route dispatch based on live TST projections."
            </p>
          </div>

          {/* Card 2 */}
          <div className="glass-panel scroll-animate delay-150" style={{ padding: "30px", display: "flex", flexDirection: "column", gap: "16px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <div style={{ width: "40px", height: "40px", borderRadius: "50%", background: "#1E293B", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "18px" }}>👩</div>
              <div>
                <div style={{ fontWeight: "700", fontSize: "14px" }}>Fariha Rahman</div>
                <div style={{ fontSize: "11px", color: "#64748B" }}>Perishable Retail Merchant</div>
              </div>
            </div>
            <div style={{ color: "#10B981", fontSize: "12px" }}>★★★★★</div>
            <p style={{ color: "#CBD5E1", fontSize: "13.5px", lineHeight: "1.6", fontStyle: "italic" }}>
              "The dynamic heat route calculations are highly precise. We haven't had a single batch cargo spoil since transitioning our delivery maps."
            </p>
          </div>

          {/* Card 3 */}
          <div className="glass-panel scroll-animate delay-300" style={{ padding: "30px", display: "flex", flexDirection: "column", gap: "16px" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <div style={{ width: "40px", height: "40px", borderRadius: "50%", background: "#1E293B", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "18px" }}>👨</div>
              <div>
                <div style={{ fontWeight: "700", fontSize: "14px" }}>Sabbir Ahmed</div>
                <div style={{ fontSize: "11px", color: "#64748B" }}>Chemical Distribution Manager</div>
              </div>
            </div>
            <div style={{ color: "#10B981", fontSize: "12px" }}>★★★★★</div>
            <p style={{ color: "#CBD5E1", fontSize: "13.5px", lineHeight: "1.6", fontStyle: "italic" }}>
              "The voice command integration in local Bangla makes it easy for drivers to fetch live weather warnings. Highly recommend ClimaLogix."
            </p>
          </div>
        </div>

        {/* Company Logos Strip */}
        <div className="scroll-animate" style={{ display: "flex", justifyContent: "center", gap: "16px", flexWrap: "wrap", marginTop: "64px" }}>
          <span className="logo-badge">SAVAR_AGRO_LTD</span>
          <span className="logo-badge">BENGAL_CHEM</span>
          <span className="logo-badge">DHAKA_DISTRIB</span>
          <span className="logo-badge">GREEN_MERCHANTS</span>
        </div>
      </section>

      {/* SECTION 6 — CTA FOOTER BAND */}
      <section style={{ background: "linear-gradient(135deg, #10B981 0%, #059669 100%)", padding: "80px 40px", textAlign: "center" }}>
        <div style={{ maxWidth: "800px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "20px" }}>
          <h2 style={{ fontSize: "clamp(26px, 5vw, 42px)", fontWeight: "800", color: "#0B0F19", lineHeight: "1.1", letterSpacing: "-0.02em" }}>
            Start Protecting Your Shipments Today
          </h2>
          <p style={{ color: "rgba(11, 15, 25, 0.8)", fontSize: "16px", fontWeight: "500", maxWidth: "600px", margin: "0 auto" }}>
            Free tier available. No credit card required. Deploy in minutes.
          </p>
          <div style={{ marginTop: "16px" }}>
            <button onClick={onRegister} style={{
              background: "#0B0F19", border: "none", borderRadius: "10px", color: "#10B981",
              padding: "16px 36px", cursor: "pointer", fontSize: "16px", fontWeight: "800",
      ...
      {/* FOOTER */}
      <footer style={{ background: "#0B0F19", borderTop: "1px solid rgba(255,255,255,0.04)", padding: "24px", textAlign: "center" }}>
        <p style={{ color: "#475569", fontSize: "12px" }}>
          © {new Date().getFullYear()} ClimaLogix AI. All rights reserved. Dhaka, Bangladesh.
        </p>
      </footer>
    </div>
  );
...
function safeComponent(name, props, displayName) {
  ...
  return React.createElement('div', {
    style: {
      ...
      border: '1px solid var(--border-primary)', margin: 20,
    }
  },
    React.createElement('div', { style: { fontSize: 24, marginBottom: 12 } }, '\u{1F6A7}'),
    React.createElement('div', { style: { fontSize: 13, color: 'var(--text-dim)' } },
      '\u201C' + label + '\u201D component is not loaded yet.'
    ),
...
function BatchVerificationQRView() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0B0F19", color: "#F9FAFB", padding: "40px 20px", fontFamily: "'Inter', sans-serif" }}>
      <div style={{ maxWidth: 600, margin: "0 auto", background: "#111827", borderRadius: 16, border: "1px solid rgba(16, 185, 129, 0.2)", overflow: "hidden", boxShadow: "0 10px 30px rgba(0,0,0,0.5)" }}>
        <div style={{ background: "linear-gradient(135deg, #10B981, #059669)", padding: 24, textAlign: "center" }}>
          <h1 style={{ margin: 0, fontSize: 24, fontWeight: 700, color: "#000" }}>Verified Batch Scan</h1>
          <p style={{ margin: "8px 0 0", fontSize: 14, color: "rgba(0,0,0,0.7)" }}>ClimaLogix Trust Ledger</p>
        </div>
        
        <div style={{ padding: 40, textAlign: "center", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
          ...
          <h2 style={{ margin: 0, fontSize: 28, fontFamily: "'JetBrains Mono', monospace", color: "#10B981" }}>{batchId}</h2>
          <div style={{ display: "inline-block", background: "rgba(16, 185, 129, 0.1)", color: "#10B981", padding: "4px 12px", borderRadius: 20, fontSize: 12, fontWeight: 600, marginTop: 12, border: "1px solid rgba(16, 185, 129, 0.3)" }}>
            BARI CERTIFIED ✓
          </div>
        </div>

        <div style={{ padding: 32 }}>
          <h3 style={{ fontSize: 14, textTransform: "uppercase", color: "#94A3B8", letterSpacing: "0.05em", marginBottom: 16 }}>Batch Details</h3>
          <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 14 }}>
            <tbody>
              <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                <td style={{ padding: "12px 0", color: "#94A3B8" }}>Product</td>
                <td style={{ padding: "12px 0", textAlign: "right", fontWeight: 600 }}>Premium Organic Compost</td>
              </tr>
              <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                <td style={{ padding: "12px 0", color: "#94A3B8" }}>Status</td>
                <td style={{ padding: "12px 0", textAlign: "right", color: "#10B981", fontWeight: 700 }}>Active</td>
              </tr>
              <tr style={{ borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                <td style={{ padding: "12px 0", color: "#94A3B8" }}>Initial DVS</td>
                <td style={{ padding: "12px 0", textAlign: "right", fontWeight: 600, fontFamily: "'JetBrains Mono', monospace" }}>92/100</td>
              </tr>
              <tr>
                <td style={{ padding: "12px 0", color: "#94A3B8" }}>Origin</td>
                <td style={{ padding: "12px 0", textAlign: "right", fontWeight: 600 }}>Savar Green Refineries</td>
              </tr>
            </tbody>
          </table>
          
          <div style={{ marginTop: 32, textAlign: "center" }}>
            <button onClick={() => window.location.href = "/"} style={{ padding: "12px 24px", background: "transparent", border: "1px solid rgba(16, 185, 129, 0.3)", color: "#10B981", borderRadius: 8, cursor: "pointer", fontWeight: 600 }}>
              Return to Platform
            </button>
          </div>
        </div>
...
function CLimaLogixApp() {
  ...
  useEffect(() => {
    ...
    const tick = () => {
      fetchForCoords(lat, lon, { source: liveWeather.source === "live-device" ? "live-device" : "live-zone", label: activeZone });
    };
    tick();
  ...
  const currentHour = new Date().getHours();
  const activeUhi = UHI_ZONES[activeZone] || { offset: 0 };
  ...
  const getTabsForRole = (role) => {
    ...
    if (isInspector) {
      ...
      return [
        { id: "dashboard",    label: "Overall Dashboard",     icon: "⊞",  layer: "L0" },
        { id: "inventory",    label: "SME Inventory",         icon: "📲", layer: "L3" },
  ...
  useEffect(() => {
    if (currentUser) {
      ...
      setLoginWelcome({ name, role, label: getRoleLabel(role) });
  ...
  if (typeof window !== "undefined" && window.location.pathname.includes('/batch-verification-qr')) {
    return <BatchVerificationQRView />;
  }
  ...
  return (
    <div style={{
      ...
      {loginWelcome && (
        <div className="welcome-toast">
          <div style={{
            ...
            {loginWelcome.role === "admin" || loginWelcome.role === "inspector" ? "🔍" :
             loginWelcome.role === "processor" || loginWelcome.role === "manufacturer" ? "📦" : "🌿"}
          </div>
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontFamily: "Inter", fontSize: 13, fontWeight: 600, color: "#10B981", marginBottom: 3 }}>
              Welcome back, {loginWelcome.name}!
            </div>
            <div style={{ fontFamily: "Inter", fontSize: 12, color: "#9CA3AF", lineHeight: 1.4 }}>
              Signed in as <span style={{ color: "#F9FAFB", fontWeight: 500 }}>{loginWelcome.label}</span>.
              Routed to your personalized dashboard.
            </div>
          </div>
          <button className="welcome-toast-dismiss" onClick={() => setLoginWelcome(null)} aria-label="Dismiss">×</button>
        </div>
      )}
          ...
          <div style={{
            ...
            <span style={{
              ...
              {liveWeather?.source === "live-device" ? "● LIVE · GPS"
                : liveWeather?.source === "live-zone" ? "● LIVE · ZONE"
      ...
      <main style={{ padding: "32px 48px", width: "100%", margin: "0 auto" }}>
        ...
        {activeTab === "settings" && safeComponent("SettingsView", {})}

        {activeTab === "marketplace" && <MarketplaceView products={productsList} isLoading={isLoadingProducts} marketplaceSubTab={marketplaceSubTab} setMarketplaceSubTab={setMarketplaceSubTab} />}
        {activeTab === "chatbot" && (
          <ChatbotView
            setTab={setTab}
